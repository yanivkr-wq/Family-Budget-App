          ...
          <table className="min-w-full text-sm">
            ...
            <tbody>
              ...
              {(() => {
                ...
                // ── Three groups by transaction date ──────────────────────
                ...
                const carryOver    = visible.filter((t) => t.date <  monthStart);
                const currentCycle = visible.filter((t) => t.date >= monthStart && t.date <= props.cycleChargeDate);
                const nextCycle    = visible.filter((t) => t.date >  props.cycleChargeDate);
                ...
                const renderRow = (t: Transaction, groupChargeDate: string) => {
                  ...
                  const effectiveChargeDate = t.chargeDate ?? groupChargeDate;
                  const isPendingCharge     = !!effectiveChargeDate && effectiveChargeDate > todayStr;

...
export const WIDGET_SPECS: WidgetSpec[] = [
  ...
  // ─── Narrative summary ──────────────────────────────────────────────────
  {
    ...
    dataSource: 'bank',
    dataSourceNotes: 'Net-cash-flow bullet pulls from getIncomeVsExpenses (bank-only). Other bullets pull from finding arrays of other cards (which use their own data sources — see those specs).',
    ...
    queryFunction: 'composeStory (in apps/web/src/components/insights/narrative-summary.tsx)',
  ...
  },
  {
    ...
    dataSource: 'bank',
    dataSourceNotes: 'Subtotals over the rows that pass the same banner filters (excludes transfers + excluded_from_totals).',
    timeScope: 'active-billing-month',
    filters: ['inherited from cycle banner'],
    mathRule: 'Per-date SUM split by sign + is_recurring + is_installment.',
    exclusions: STANDARD_SPENDING_EXCLUSIONS,
    queryFunction: 'apps/web/src/components/transactions/list.tsx',
  },
  ...
  },
  {
    ...
    exclusions: [],
    queryFunction: 'createReminderForAllPatterns (recurring/actions.ts)',
  },
  ...
  },
  {
    ...
    exclusions: [],
    queryFunction: 'advancePayment (installments/actions.ts)',
  },
...

  {
    ...
    dataSource: 'bank',
    dataSourceNotes: 'Reads transactions, filtered to category IDs where category.is_savings=true.',
    timeScope: 'active-billing-month',
    filters: [
      'billing_month = activeMonth',
  ...
  },
  {
    ...
    dataSource: 'bank',
    dataSourceNotes: 'Derives from the two preceding tiles.',
    timeScope: 'active-billing-month',
    filters: ['inherited'],
...

  {
    ...
    queryFunction: 'apps/web/src/app/(app)/projects/page.tsx',
  },
  {
